Raxon::RouteLoader.register(__FILE__) do |endpoint|
  ...
  endpoint.request_body type: :object, description: "Statistic parameters", required: true do |body|
    body.property :statistic, type: :object, required: true, description: "Statistic data" do |statistic|
      ...
      statistic.property :equation_statistics, type: :array, description: "Equation statistics"
      ...
      statistic.property :post_ids, type: :array, description: "IDs of posts"
      statistic.property :combination_statistics, type: :array, description: "Combination statistics"
    end
  end
